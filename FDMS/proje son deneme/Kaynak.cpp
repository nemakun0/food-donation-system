...
// This a function that indicates the amount of the food, the name of the food and country where is sent that have donated
...
//This a a function that indicates the money  and the country where is sent that has donated once. 
...
// This is a function that indicates the quantity of the money and the country where is sent that has donated monthly and also it shows the day of the every month
...
againDonor:
	std::cout << "If you are a personal donor, please press 1. If you are a corporate donor, please press 2: ";
	std::getline(std::cin, donortype); // We use getline to handle user input of more than one character.

	/* We use an if block to handle the selection of donor type.
	If the user selects a different type of character, the else block will prompt the question again. */
	if (donortype == "1")
	{
